...
- construct first difference by choosing **Object** then **Generate Series** and entering **d_DJ = d(DJ)**

- construct log transformed data by hosing **Object** then **Generate Series** and entering **log_DJ = log(DJ)**
