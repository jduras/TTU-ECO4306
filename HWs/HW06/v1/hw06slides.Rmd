...
\begin{center}
    \includegraphics[trim=0cm 0cm 0cm 0cm, clip, width=9cm]{figures/hw07q01_fig00_txlubb3urn_ts_whole.png}
\end{center}
...
\begin{center}
    \includegraphics[trim=0.5cm 0cm -0.5cm 0cm, clip, width=9cm]{figures/hw07q01_fig01_txlubb3urn_ts.png}
\end{center}
...
\begin{center}
    \includegraphics[trim=0cm 5.25cm -1cm 1.6cm, clip, width=4.5cm]{figures/hw07q01_fig02_txlubb3urn_corr.png}
\end{center}
...
- estimation results
\begin{center}
    \includegraphics[trim=0cm 3.6cm 0cm 0cm, clip, width=5.5cm]{figures/hw07q01_fig03_txlubb3urn_eq1.png}
\end{center}
...
\begin{center}
    \hspace*{-1cm}
    \includegraphics[trim=1cm -9cm 0.5cm 0cm, clip, width=5.5cm]{figures/hw07q01_fig04_txlubb3urn_eq1_resid_ts.png}
    \includegraphics[trim=0cm 5.25cm -1cm 1.6cm, clip, width=4.5cm]{figures/hw07q01_fig05_txlubb3urn_eq1_resid_corr.png}
\end{center}
...
\begin{center}
    \includegraphics[trim=0cm 0.5cm 0cm 0cm, clip, width=9cm]{figures/hw07q01_fig06_txlubb3urn_eq1_f.png}
\end{center}
...
\begin{center}
    \includegraphics[trim=0.5cm 0.5cm 0cm 0.5cm, clip, width=9cm]{figures/hw07q01_fig07_txlubb3urn_eq1_e.png}
\end{center}
...
\begin{center}
    \includegraphics[trim=0cm 0cm 0cm 0cm, clip, width=5.5cm]{figures/hw07q01_fig08_txlubb3urn_eq1_dl.png}
\end{center}
