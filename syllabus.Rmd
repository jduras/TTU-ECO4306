...
\begin{tabular*}{0.9\textwidth}%
    {@{\extracolsep{\fill}}ll} 
    Instructor: Jan Duras  & Teaching Assistant: TBA \\
    Office: 257 Holden Hall  & Office: TBA \\
    E-mail: \href{mailto:jan.duras@ttu.edu}{jan.duras@ttu.edu} & E-mail: TBA \\
    Office Hours: T 4 p.m. - 6 p.m. & Office Hours: TBA  \\
\end{tabular*} \bigskip
