...
wfcreate m 1953m4 2008m4

cd "D:\Dropbox\User\Academic\06TexasTech\02Teaching\13 4306 Economic and Business Forecasting Spring 2019\codes\lec07\"

' import data
import(link) "GS5.csv" ftype=ascii rectype=crlf skip=0 fieldtype=delimited delim=comma colhead=1 eoltype=pad badfield=NA @id @date(date) @smpl @all

' generate time series with mean of returns for treasury yield
genr dy = 100*( gs5/gs5(-1) - 1 )
